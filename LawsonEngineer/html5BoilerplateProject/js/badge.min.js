(function(){
    ...
    var init = (function(){
        ...
        if(widgets.length){
            ...
            addCSS('http://cdnjs.cloudflare.com/ajax/libs/octicons/2.2.2/octicons.min.css');
            addCSS('http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css');
